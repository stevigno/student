...
class UserProfileForm(forms.ModelForm):
    profile_picture = forms.ImageField(required=False, error_messages={'invalid': ("Please upload a valid image")},
                                       widget=forms.FileInput)

    class Meta:
        model = UserProfile
        fields = ['address_line_2', 'address_line_1', 'city', 'state', 'country', 'profile_picture']
